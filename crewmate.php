...
<div class="poisk">
                      ...
                      foreach ($data as $elem) {
                          ...
                          $result .= '<td><center><button href="?del=' . $elem['Id'] . '" onclick="openFormUpd()">изменить</button></center></td>';
                            echo "</tr>";
                        }
...
<!--Кнопка изменить-->
                    <button class="open-button-upd" onclick="openFormUpd()">Изменить </button>
